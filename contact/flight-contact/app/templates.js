  ...
  function() {
          ...
          <div class="navbar-inner">
            <div class="container" >
              <form class="navbar-form">
                ...
                <button id="addContact" type="button" class="btn">
                  <i class="icon-plus"></i>
                </button>
                <button id="resyncContact" type="button" class="btn btn-success">
                  <i class="icon-ok"></i>
                </button>
              </form>
            </div>
          ...
          <table id="contactsTable" class="table table-hover">
            <tbody>
              ...
              <tr id="contact-{{id}}">
                ...
                <td class="img">
                  <img src="http://lorempixel.com/64/64/people/" class="img-polaroid"/>
                </td>
    ...
    var contatEditTemplate = '
        <div id="contactEdit">
          ...
          <button id="delete-{{id}}" class="btn btn-large btn-block btn-danger delete"
